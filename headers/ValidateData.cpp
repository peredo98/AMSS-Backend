...
public:
    ...
    bool validate_all(string name, string lastname, string id, string gender){
        try{
            cout << "Name: " << endl;
            validar_nombre(name);
    ...
    bool validar_matricula(string matricula)
    {
    ...
    int validar_nombre(string nombre)
    {
        int j = nombre.length();
        for (int i = 0; i < j; i++)
        {
